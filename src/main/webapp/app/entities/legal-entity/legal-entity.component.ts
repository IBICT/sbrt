...
export class LegalEntityComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.legalEntityService
            ...
            .subscribe(
                (res: HttpResponse<ILegalEntity[]>) => this.paginateLegalEntities(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/legal-entity'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateLegalEntities(data: ILegalEntity[], headers: HttpHeaders) {
